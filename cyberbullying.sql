...
--
-- Host: localhost
-- Generation Time: Nov 28, 2021 at 01:45 PM
...
--
-- Database: `detection_of_cyberbullying`
--
CREATE DATABASE IF NOT EXISTS `detection_of_cyberbullying` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detection_of_cyberbullying`;
...
(2, 'Manjunath', 'tmksmanju123@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
(4, 'SVM', '98.67092866756393'),
(5, 'Logistic Regression', '97.48485868102289'),
(6, 'Naive Bayes', '94.9528936742934'),
(7, 'SVM', '98.41857335127861'),
(8, 'SVM', '98.20827725437415'),
(9, 'SVM', '98.53633916554509'),
(10, 'SVM', '98.62886944818304');
...
(5, 'Non Offensive or Non Cyberbullying', '60.0'),
(6, 'Offensive or Cyberbullying', '40.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_tweet_message_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_tweet_message_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(1, 'studiolife aislife requires passion dedication willpower to find newmaterials', 'Non Offensive or Non Cyberbullying'),
(2, 'studiolife aislife requires passion dedication willpower to find newmaterials', 'Non Offensive or Non Cyberbullying'),
(3, 'studiolife aislife requires passion dedication willpower to find newmaterials', 'Non Offensive or Non Cyberbullying'),
(4, 'hey guys tommorow is the last day of my exams i m so happy yay', 'Non Offensive or Non Cyberbullying'),
(5, 'thought factory bbc neutrality on right wing fascism politics media blm brexit trump leadership gt 3', 'Offensive or Cyberbullying'),
(6, 'chick gets fucked hottest naked lady', 'Offensive or Cyberbullying'),
(7, 'chick gets fucked hottest naked lady', 'Offensive or Cyberbullying'),
(8, 'finally at peace sad news so many lives lost hatred no answer haiku haikuchallenge micropoetry poetry finally', 'Non Offensive or Non Cyberbullying'),
(9, 'everybody hates the white crayon', 'Offensive or Cyberbullying'),
(10, 'emma stone on hollywood they ve given my jokes away to male co stars via', 'Offensive or Cyberbullying'),
(11, 'some people are just too committed to their own disfunction truth tired', 'Non Offensive or Non Cyberbullying'),
(12, 'inked polar bear climb racing angry polar bear climb racing the polar bear living in cold places lookin', 'Non Offensive or Non Cyberbullying'),
(13, 'leicester police officer sacked after he was filmed using language england', 'Offensive or Cyberbullying'),
(14, 'gbp usd focused on 1 4090 uob blog silver gold forex', 'Non Offensive or Non Cyberbullying'),
(15, 'i know how u feel i didn t know her only seen jocoxmp on bbc parliament few times but still trying not 2 cry', 'Non Offensive or Non Cyberbullying');
